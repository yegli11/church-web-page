...
const DETAILS: Record<string, Partial<Ministry>> = {
  ujieres: {
    team: [
      { name: 'Teodora Borjas',      role: 'Líder Principal', isLeader: true },
      { name: 'Gregoria Borjas',     role: 'Integrante' },
      { name: 'Fabiana Queipo',      role: 'Integrante' },
      { name: 'Milagros Rodriguez',  role: 'Integrante' },
      { name: 'Maribel Carrero',     role: 'Integrante' },
      { name: 'Yonardis Muñoz',      role: 'Integrante' },
      { name: 'María Bentacourt',    role: 'Integrante' },
      { name: 'Yohana Moralez',      role: 'Integrante' },
      { name: 'Daimar Piedra',       role: 'Integrante' },
      { name: 'Rosa Castillo',       role: 'Integrante' },
      { name: 'Derlimar Piedra',     role: 'Integrante' },
      { name: 'Yenireth Briceño',    role: 'Integrante' },
      { name: 'Leida Bauza',         role: 'Integrante' },
      { name: 'Marlene de Piedra',   role: 'Integrante' },
      { name: 'Onardys Reyes',       role: 'Integrante' },
      { name: 'Renatta Hernandez',   role: 'Integrante' },
      { name: 'Ada Castillo',        role: 'Integrante' },
    ],
  },
  musical: {
  ...
  protocolo: {
    ...
    team: [
      { name: 'Maritza Aldana',      role: 'Líder Principal', isLeader: true, photo: '/images/ministries/protocolo/integrantes/maritzaA-protocolo.jpg' },
      { name: 'Lilia Briceño',       role: 'Integrante', photo: '/images/ministries/protocolo/integrantes/liliaB-protocolo.jpg'     },
      { name: 'Mercedes Surmay',     role: 'Integrante', photo: '/images/ministries/protocolo/integrantes/mercedesS-protocolo.jpg'  },
      { name: 'Esneira Chacin',      role: 'Integrante', photo: '/images/ministries/protocolo/integrantes/esneiraC-protocolo.jpg'   },
      { name: 'Nairobi Gil',         role: 'Integrante', photo: '/images/ministries/protocolo/integrantes/nairobiG-protocolo.jpg'   },
      { name: 'Marisol Contreras',   role: 'Integrante', photo: '/images/ministries/protocolo/integrantes/marisolC-protocolo.jpg'   },
      { name: 'Miriam Zerpa',        role: 'Integrante', photo: '/images/ministries/protocolo/integrantes/miriamZ-protocolo.jpg'    },
      { name: 'Sixdelys Zerpa',      role: 'Integrante', photo: '/images/ministries/protocolo/integrantes/sixdelyZ-protocolo.jpg'   },
      { name: 'Lisbeth Queipo',      role: 'Integrante', photo: '/images/ministries/protocolo/integrantes/lisbethQ-protocolo.jpg'   },
      { name: 'Maribel Colina',      role: 'Integrante', photo: '/images/ministries/protocolo/integrantes/maribelC-protocolo.jpg'   },
      { name: 'Yaneth Zerpa',        role: 'Integrante', photo: '/images/ministries/protocolo/integrantes/janethZ-protocolo.jpg'    },
      { name: 'Nilsa Hernandez',     role: 'Integrante' },
      { name: 'Diomara Sarmiento',   role: 'Integrante', photo: '/images/ministries/protocolo/integrantes/diomaraS-protocolo.jpg'   },
      { name: 'Margarita Figueroa',  role: 'Integrante', photo: '/images/ministries/protocolo/integrantes/margaritaF-protocolo.jpg' },
      { name: 'José Castillo',       role: 'Integrante', photo: '/images/ministries/protocolo/integrantes/joseC-protocolo.jpg'      },
      { name: 'Eleisa Medina',       role: 'Integrante', photo: "/images/ministries/protocolo/integrantes/eleisaM'-protocolo.jpg"   },
      { name: 'Maria de Gomez',      role: 'Integrante' },
      { name: 'Maricarmen Querales', role: 'Integrante', photo: '/images/ministries/protocolo/integrantes/maricarmeQ-protocolo.jpg' },
      { name: 'Elena Gatica',        role: 'Integrante', photo: '/images/ministries/protocolo/integrantes/elenaG-protocolo.jpg'     },
    ],
  ...
  infantil: {
    ...
    team: [
      ...
      { name: 'Daniel Montiel',      role: 'Ayudante',                         photo: '/images/ministries/multimedia/integrantes/danielM-multimedia.jpg', color: '#A6FE5A' },
      { name: 'Alejandro Montiel',   role: 'Ayudante',                         photo: '/images/ministries/multimedia/integrantes/alejandroMontiel-multimedia.jpg',     color: '#FF9700' },
      { name: 'Jesús Perozo',        role: 'Ayudante',                         photo: '/images/ministries/multimedia/integrantes/jesusP-multimedia.jpg',  color: '#00DBEE' },
    ],
    steps: [
      {
        number: '01',
  ...
  multimedia: {
    ...
    team: [
      { name: 'Daniel González',   role: 'Líder Principal · Fotografía',  photo: '/images/ministries/multimedia/integrantes/hectorG-multimedia.jpg',      isLeader: true,  color: '#93C5FD' },
      { name: 'Yeglimar Montanez', role: 'Líder Secundaria · Diseño y Redes Sociales', photo: '/images/ministries/multimedia/integrantes/yegli-multimedia.jpg', isLeader: true,             color: '#FDA4AF' },
      { name: 'Alejandro Montiel', role: 'Fotografía y Diseño',       photo: '/images/ministries/multimedia/integrantes/alejandroMontiel-multimedia.jpg',   color: '#FDE68A' },
      { name: 'Fabiola Sayago',    role: 'Diseño y Redes Sociales',   photo: '/images/ministries/multimedia/integrantes/fabiolaS-multimedia.jpg',                     color: '#C4B5FD' },
      { name: 'Kendriana Oviedo',  role: 'Diseño y Redes Sociales',   photo: '/images/ministries/multimedia/integrantes/kendriana-multimedia.jpg',                                                                                                           color: '#86EFAC' },
      { name: 'Lohisbell Díaz',    role: 'Proyección y Transmisión',  photo: '/images/ministries/multimedia/integrantes/lohisbellD-multimedia.jpg',                           color: '#FCA5A1' },
      { name: 'Leonel Fabelo',     role: 'Proyección y Transmisión',  photo: '/images/ministries/multimedia/integrantes/leonelF-multimedia.jpg',                                                                                                      color: '#7DD3FC' },
      { name: 'Sebastián García',  role: 'Proyección y Transmisión',  photo: '/images/ministries/multimedia/integrantes/sebastianG-multimedia.jpg',                             color: '#F9A8D4' },
      { name: 'Jesús Perozo',      role: 'Proyección y Transmisión',  photo: '/images/ministries/multimedia/integrantes/jesusP-multimedia.jpg',                                 color: '#A7F3D0' },
      { name: 'Daniel Montiel',    role: 'Proyección y Transmisión',  photo: '/images/ministries/multimedia/integrantes/danielM-multimedia.jpg',                                                                                                          color: '#FCD34D' },
    ],
    designs: [
