...
const DETAILS: Record<string, Partial<Ministry>> = {
  ...
  multimedia: {
    ...
    team: [
      { name: 'Daniel González',   role: 'Líder Principal · Fotografía',        isLeader: true,  color: '#93C5FD' },
      { name: 'Yeglimar Montanez', role: 'Líder Secundaria · Diseño y Redes Sociales', isLeader: true,             color: '#FDA4AF' },
      { name: 'Alejandro Montiel', role: 'Fotografía y Diseño',                                                                                                               color: '#FDE68A' },
      { name: 'Fabiola Sayago',    role: 'Diseño y Redes Sociales',                               color: '#C4B5FD' },
      { name: 'Kendriana Oviedo',  role: 'Diseño y Redes Sociales',                                                                                                           color: '#86EFAC' },
      { name: 'Lohisbell Díaz',    role: 'Proyección y Transmisión',                             color: '#FCA5A1' },
      { name: 'Leonel Fabelo',     role: 'Proyección y Transmisión',                                                                                                      color: '#7DD3FC' },
      { name: 'Sebastián García',  role: 'Proyección y Transmisión',                             color: '#F9A8D4' },
      { name: 'Jesús Perozo',      role: 'Proyección y Transmisión',                                 color: '#A7F3D0' },
