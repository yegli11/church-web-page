...
const DETAILS: Record<string, Partial<Ministry>> = {
  ...
  protocolo: {
    ...
    team: [
      { name: 'Maritza Aldana',       role: 'Integrante' },
      { name: 'Lilia Briceño',        role: 'Integrante' },
      { name: 'Mercedes Surmay',      role: 'Integrante' },
      { name: 'Esneira Chacin',       role: 'Integrante' },
      { name: 'Nairobi Gil',          role: 'Integrante' },
      { name: 'Marisol Contreras',    role: 'Integrante' },
      { name: 'Miriam Zerpa',         role: 'Integrante' },
      { name: 'Sixdelys Zerpa',       role: 'Integrante' },
      { name: 'Lisbeth Queipo',       role: 'Integrante' },
      { name: 'Maribel Colina',       role: 'Integrante' },
      { name: 'Yaneth Zerpa',         role: 'Integrante' },
      { name: 'Nilsa Hernandez',      role: 'Integrante' },
      { name: 'Diomara Sarmiento',    role: 'Integrante' },
      { name: 'Margarita Figueroa',   role: 'Integrante' },
      { name: 'José Castillo',        role: 'Integrante' },
      { name: 'Eleisa Medina',        role: 'Integrante' },
      { name: 'Maria de Gomez',       role: 'Integrante' },
      { name: 'Maricarmen Querales',  role: 'Integrante' },
      { name: 'Elena Gatica',         role: 'Integrante' },
    ],
